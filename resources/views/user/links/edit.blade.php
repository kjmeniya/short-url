    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
      <div class="card-header border-0 bg-body-tertiary py-4 px-4 d-flex justify-content-between align-items-center">
        <div>
          ...
          <h5 class="mb-0">
            <i data-lucide="pencil" class="icon-sm me-2 text-primary"></i>Edit Link &mdash; <code>{{ $link->code }}</code>
          </h5>
        </div>
        ...
        <form id="edit-link-form" action="{{ route('user.links.update', $link->id) }}" method="POST" novalidate>
          ...
          <div class="section-card mb-5">
            <div class="section-heading d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <p class="text-muted small mb-0">Refresh the target URL or rename the link.</p>
              </div>
            </div>
          ...
          <div class="section-card mb-5">
            <div class="section-heading d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <p class="text-muted small mb-0">Customize the slug, status, and lifecycle of this URL.</p>
              </div>
            </div>
          ...
          <div class="mb-3">
            ...
            <div id="slug-feedback" class="form-text mt-1">
              Lowercase letters, numbers, hyphens, underscores A? 3??"64 chars A? Auto-code: <strong>{{ $link->code }}</strong>
            </div>
            @error('custom_alias')
            ...
            <div class="alert alert-light border text-muted small mb-0">
              Custom slugs are locked on your current plan.
            </div>
            @endif
          </div>
          ...
          <div class="mb-3">
            ...
            @else
            <div class="alert alert-light border text-muted small mb-0">
              Setting expirations requires an upgraded plan.
            </div>
            @endif
          </div>
          ...
          <div class="mb-0">
            ...
            @else
            <div class="alert alert-light border text-muted small mb-0">
              Click limits unlock with a paid plan.
            </div>
            @endif
          </div>
          ...
          <div class="mb-4">
            ...
            @else
            <div class="alert alert-light border text-muted small mb-0">
              Password protection is unavailable on this plan.
            </div>
            @endif
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="alert alert-light border text-muted small mb-0">
              Upgrade to enable private links.
            </div>
            @endif
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="alert alert-light border text-muted small mb-0">
              Time-limited story links are part of higher plans.
            </div>
            @endif
          </div>
          ...
          <div class="mb-4">
            ...
            <div class="alert alert-light border text-muted small mb-0">
              Self-destructing links require a Pro plan.
            </div>
            @endif
          </div>
          ...
          <div class="section-card mb-5">
            <div class="section-heading d-flex align-items-center mb-3">
              ...
              <div>
                ...
                <p class="text-muted small mb-0">Target visitors by device, time, channel, or reputation.</p>
              </div>
            </div>
          ...
          <div class="mb-4">
            ...
            @else
            <div class="alert alert-light border text-muted small mb-0">
              Custom social previews are available on Pro plans.
            </div>
            @endif
          ...
          <div class="mb-4">
            ...
            <div class="collapse {{ old('ip_blocks') ? 'show' : '' }}" id="ipBlockingRules">
              <div class="card card-body bg-light border-0 mt-2 p-3">
                ...
                <div id="ip-blocks-container">
                  @php $oldIpBlocks = old('ip_blocks', $link->ip_blocks ?? []); @endphp
            ...
            @else
            <div class="alert alert-light border text-muted small mb-0">
              IP blocking unlocks on the Pro plan.
            </div>
            @endif
        ...
        <div class="card border-0 shadow-sm rounded-4 h-100">
          <div class="card-body">
            <div class="d-flex align-items-center mb-3">
              ...
              <h6 class="fw-semibold mb-0">Link Snapshot</h6>
            </div>
