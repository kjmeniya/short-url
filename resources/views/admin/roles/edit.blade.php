...
@section('title', $title ?? 'Edit Role')
@section('description', $description ?? 'Edit role details and modify permission assignments')
@section('keywords', $keywords ?? 'edit role, modify role, update role, role settings')
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3 pb-3 border-bottom">
          <h6 class="card-title mb-0">Edit Role: {{ $role->display_name }}</h6>
          <div class="d-flex gap-2">
            <a href="{{ route('admin.roles.show', $role) }}" class="btn btn-outline-info btn-sm">
              <i data-lucide="eye" class="icon-sm me-1"></i>View
            </a>
        ...
        <form action="{{ route('admin.roles.update', $role) }}" method="POST" id="roleForm">
          ...
          <div class="mb-4">
            ...
            <div class="border rounded permission-category mb-3">
              <div class="permission-category-header border bg-light" aria-expanded="true">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="d-flex align-items-center">
                    <label class="form-check-label select-all-category me-3 text-primary cursor-pointer"
                      ...
                      <input type="checkbox" class="form-check-input select-all-category-checkbox me-1"
                      ...
                      <div class="permission-item">
                        <div class="form-check">
                          ...
                          <label class="form-check-label" for="permission-{{ $permission['id'] }}">
                            ...
                            <br><small class="text-info">{{ $permission['method'] }} {{ $permission['route_name'] }}</small>
                            @endif
                          </label>
                        </div>
                      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('.select-all-category-checkbox').each(function() {
