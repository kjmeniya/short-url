...
@section('title', $title ?? 'Edit Blog Post')
@section('description', $description ?? "Edit {$blog->title} blog post.")
@section('keywords', $keywords ?? 'edit blog post, update article, blog editing')
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 pb-3 border-bottom gap-2">
                    <h6 class="card-title mb-0">Edit Blog Post: {{ $blog->title }}</h6>
                ...
                <form id="blogEditForm" action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('excerpt') is-invalid @enderror"
                                            ...
                                            placeholder="Enter a brief description of the post" required>{{ old('excerpt', $blog->excerpt) }}</textarea>
                                        @error('excerpt')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="tinymceContent" class="form-label">Content <span class="text-danger">*</span></label>
                                        <textarea class="form-control @error('content') is-invalid @enderror"
                                            id="tinymceContent" name="content" rows="15">{{ old('content', $blog->content) }}</textarea>
                                        @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="border-end">
                                                <h4 class="mb-1">{{ number_format($blog->views_count) }}</h4>
                                                <p class="text-muted mb-0">Views</p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <h4 class="mb-1">{{ $blog->reading_time ?? 0 }}</h4>
                                    ...
                                    <div class="text-center">
                                        <small class="text-muted">
                                            ...
                                            Updated: {{ $blog->updated_at->format('M d, Y g:i A') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            'currentImage' => $blog->featured_image ? $blog->featured_image_url : null
                            ])
